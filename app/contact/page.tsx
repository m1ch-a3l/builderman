...
import { Mail, Phone, MapPin, ArrowUpRight, Facebook, Linkedin, Youtube } from "lucide-react";
            ...
            <div>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  {[
                    { href: "#", label: "Facebook", el: <Facebook size={15} /> },
                    { href: "#", label: "LinkedIn", el: <Linkedin size={15} /> },
                    {
                    ...
                    { href: "#", label: "YouTube", el: <Youtube size={15} /> },
                  ].map(({ href, label, el }) => (
                    <a
                      key={label}
                      href={href}
